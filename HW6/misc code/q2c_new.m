...
%         temp = transpose(temp);
        ...
        %compensate for power lost in nulling a carrier
...
%         if ber_trial > target_ber
%             throughput = 0;
%         else
%             throughput = (Nbits*ofdm_symbols);
%         end
%         throughput_snr = throughput_snr + throughput;
...
legend_str ="OFDM Bit-loading- Delay Spread:"+string(tau_rms*1e9)+"ns";
...
figure
legend_str = "Adaptive Mod., DS:"+string(tau_rms*1e9)+"ns";
