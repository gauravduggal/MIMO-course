function [th] = get_throughput_rayleigh_theoretical(kvec,snrvec,target_ber,ofdm_symbols,N, block_duration)
Ntrials = 10000;
    ...
    for snridx = 1:length(snrvec)
        for trial = 1:Ntrials
            ...
            if ber > target_ber
                ...
                databits = k*N/(511/250);
                throughput = databits*ofdm_symbols/block_duration;
            end
